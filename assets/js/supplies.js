...
// Supplies category items (works just like assets/js/items.js, but separate list + images folder)
//
// ID convention (recommended): "supplies:<unique-item-id>"
// Example: "supplies:embroidered-patch"
//
// Images folder (recommended): /assets/shop-supplies/
//
...
window.SUPPLIES_ITEMS = [
  ...
  /*
  {
    id: "supplies:example-item",
    name: "Example Supplies Item",
    ...
    image: "/assets/shop-supplies/example_thumb.jpg",

    // Optional: lightbox gallery images (full-size)
    images: [
      "/assets/shop-supplies/example_full.jpg",
      "/assets/shop-supplies/example_alt.jpg"
    ],
    ...
    // ===== reporting fields =====
    chair: { name: "Supplies", email: "" }, // email managed via admin
...
// -----------------------------------------------------------------------------
(function autoRegisterSuppliesItems() {
  try {
    const list = Array.isArray(window.SUPPLIES_ITEMS) ? window.SUPPLIES_ITEMS : [];
